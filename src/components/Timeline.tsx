    ...
    <div className="relative max-w-6xl mx-auto">
      ...
      <div className="mt-16 p-8 bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700">
        ...
        <div className="text-slate-300 space-y-2">
          <p>• <a href="https://www.oreilly.com/library/view/ai-engineering/9781098166298/" className="text-blue-400 hover:text-blue-300 transition-colors">AI Engineering by Chip Huyen (O'Reilly)</a></p>
          <p>• <a href="https://aima.cs.berkeley.edu/" className="text-blue-400 hover:text-blue-300 transition-colors">Artificial Intelligence: A Modern Approach by Stuart Russell and Peter Norvig</a></p>
          ...
          <p>• <a href="https://en.wikipedia.org/wiki/Attention_Is_All_You_Need" className="text-blue-400 hover:text-blue-300 transition-colors">"Attention Is All You Need" - Original Transformer Paper</a></p>
